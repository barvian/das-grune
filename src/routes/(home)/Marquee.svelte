...
<a bind:this={wrapper} href="/#discuss" class="bg-gray-900 block group relative before:bg-gray-800 py-[1em] text-[clamp(1.75rem,1.08rem+3.33vw,3.75rem)] before:opacity-0 before:inset-0 before:absolute hover:before:opacity-100 before:transition overflow-hidden">
